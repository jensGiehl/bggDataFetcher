...
public class CollectionQueryParameters {
  ...
  @Builder.Default private Type subType = Type.BOARDGAME;
  ...
  /**
   * Filter on minimum BGG rating for that item in the collection. Note: 0 is ignored... you can use
   * -1 though, for example min -1 and max 1 to get items w/no bgg rating.
   */
  ...
  /**
   * Filter to show private collection info. Only works when viewing your own collection, and you
   * are logged in.
   */
  private Boolean showprivate;

  /**
   * Restrict the collection results to the single specified collection id. Collid is returned in
   * the results of normal queries as well.
   */
