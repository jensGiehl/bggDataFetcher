...
class UrlBuilderTest {
  ...
  public void shouldMapCollection() {
    ...
    String url = classUnderTest.createUrl(BASE_URL, queryParameter);
    assertThat(url)
        .isEqualTo(BASE_URL + "?test=" + URLEncoder.encode("1,2,3", StandardCharsets.UTF_8));
  }
  ...
  public void shouldMapDateTime() {
    ...
    assertThat(url)
        .isEqualTo(
            BASE_URL + "?test=" + URLEncoder.encode("2022-05-04 12:42:00", StandardCharsets.UTF_8));
  }
  ...
  public void shouldMapDate() {
    ...
    String url = classUnderTest.createUrl(BASE_URL, queryParameter);
    assertThat(url)
        .isEqualTo(BASE_URL + "?test=" + URLEncoder.encode("2022-05-04", StandardCharsets.UTF_8));
  }
  ...
  public void shouldGatherAllFields() {
    QueryParameters queryParameters =
        QueryParameters.builder().test1("42").testWithCamelCase("21").build();
